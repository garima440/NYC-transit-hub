        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-4 text-xl text-blue-100">{t("hero.description")}</p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">
              {t("updates.realTimeUpdates")}
            </h3>
            <p className="text-gray-600 dark:text-gray-300">
              {t("updates.realTimeUpdatesDescription")}
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">
              {t("trips.tripPlanning")}
            </h3>
            <p className="text-gray-600 dark:text-gray-300">
              {t("trips.tripPlanningDescription")}
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">
              {t("stations.stationInfo")}
            </h3>
            <p className="text-gray-600 dark:text-gray-300">
              {t("stations.stationInfoDescription")}
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md overflow-hidden">
            <div className="p-6">
              <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white flex items-center">
                ...
                {t("transitStatus.subwayLineStatus")}
              </h3>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-3 border-b border-gray-100 dark:border-gray-700">
                  ...
                  <span className="text-green-600 dark:text-green-400 font-medium">
                    {t("status.goodService")}
                  </span>
                </div>

                <div className="flex items-center justify-between p-3 border-b border-gray-100 dark:border-gray-700">
                  <div className="flex items-center gap-3">
                    <span className="flex-shrink-0 w-10 h-10 rounded-full bg-red-500 text-white flex items-center justify-center font-bold">
                      2
                    </span>
                    <span className="text-gray-900 dark:text-white">
                      7 Avenue Express
                  ...
                  <span className="text-yellow-600 dark:text-yellow-400 font-medium">
                    {t("status.minorDelays")}
                  </span>
                </div>

                <div className="flex items-center justify-between p-3 border-b border-gray-100 dark:border-gray-700">
                  <div className="flex items-center gap-3">
                    <span className="flex-shrink-0 w-10 h-10 rounded-full bg-green-500 text-white flex items-center justify-center font-bold">
                      4
                    </span>
                    <span className="text-gray-900 dark:text-white">
                ...
                <div className="flex items-center justify-between p-3">
                  <div className="flex items-center gap-3">
                    <span className="flex-shrink-0 w-10 h-10 rounded-full bg-orange-500 text-white flex items-center justify-center font-bold">
                      F
                    </span>
                    <span className="text-gray-900 dark:text-white">
                      Queens-Manhattan-Brooklyn Local
                    </span>
                  </div>
                  <span className="text-red-600 dark:text-red-400 font-medium">
                    {t("status.serviceChanges")}
                  </span>
                </div>
              </div>
              ...
              <div className="mt-6 text-center">
                ...
                >
                  {t("transitStatus.viewCompleteStatus")}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
      ...
      <footer className="bg-gray-800 text-white py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 max-w-7xl mx-auto">
          <p className="text-gray-400 text-sm text-center">
            © {new Date().getFullYear()} NYC Transit Hub.{" "}
